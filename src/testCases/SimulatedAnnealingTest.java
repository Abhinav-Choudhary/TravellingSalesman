...
class SimulatedAnnealingTest {
	...
	void testSimulatedAnnealing1() {
        ...
        Graph saTourGraph = new SimulatedAnnealingSolver(graph).buildTour(eulerTour);
		assertEquals(saTourGraph.totalWeight(), 6.0);
	}
	
	@Test
	void testSimulatedAnnealing2() {
		ArrayList<Edge> edges = new ArrayList<>();
		...
		EulerTour eulerTour = new EulerTour(graph);
        Graph saTourGraph = new SimulatedAnnealingSolver(graph).buildTour(eulerTour);
		assertEquals(saTourGraph.totalWeight(), 18.0);
	}
	
	@Test
	void testSimulatedAnnealing3() {
		ArrayList<Edge> edges = new ArrayList<>();
